...
import PathParticle from "./PathParticle";
 ...
 * @class StaticPathParticle
 * @extends PIXI.particles.PathParticle
 * @constructor
 * @param {PIXI.particles.Emitter} emitter The emitter that controls this PathParticle.
 */
export default class StaticPathParticle extends PathParticle
{
    /**
